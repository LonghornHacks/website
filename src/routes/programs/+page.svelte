...
<p class="mt-1">
    ...
    to be able to run workshops that are even more advanced where students get to create their own advanced projects,
    such as their own programming language or AI chatbot. Thank you for sticking with us while we figure out what the
    future holds for Longhorn Hacks!
</p>